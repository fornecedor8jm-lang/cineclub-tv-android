...
export function M3UPlayer({ item, onClose }: { item: M3UItem; onClose: () => void }) {
  ...
  const searchSubtitles = () => { setSubtitlePanel(true); void subtitleSearch.refetch(); };
